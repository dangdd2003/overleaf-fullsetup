...
export function GitTokensWidget() {
  ...
  return (
    <div className="settings-widget-container linking-git-bridge">
      <div className="linking-icon-fixed-position">
        <GitLogoOrange size={40} />
      </div>
      <div className="description-container linking-git-bridge-content">
        <div className="title-row">
          <h4 id="git-integration-heading">
            {t('git_integration', 'Git integration')}
          </h4>
        </div>
        <p className="small git-tokens-instruction-text">
          {t(
        ...
        {!hasTokens ? (
          <ul className="small git-tokens-instruction-text git-tokens-hints ps-3">
            <li>
              {t(
                ...
                {tokens.map(token => (
                  ...
                  >
                    ...
                    <td className="py-3 px-3 text-end">
                      <OLTooltip
                        id={`delete-token-${token._id}`}
                        description={t('delete_token', 'Delete token')}
                      >
                        <span>
                          <OLIconButton
                            variant="danger"
      ...
      >
        ...
        <OLModalFooter>
          <OLButton variant="secondary" onClick={() => setTokenToDelete(null)}>
            {t('cancel', 'Cancel')}
          </OLButton>
          <OLButton
            variant="danger"
