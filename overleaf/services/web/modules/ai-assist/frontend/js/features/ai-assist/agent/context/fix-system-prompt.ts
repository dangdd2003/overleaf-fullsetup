...
export const FIX_SYSTEM_PROMPT = [
  ...
  'exactly one short text block — the cause in a sentence, and what the edit',
  'changes. The user reviews the edit as a diff and accepts or rejects it, so',
  'propose it even when you are not certain. Never answer with only an',
